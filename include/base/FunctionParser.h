...
#ifndef BASE_FUNCTIONPARSER_H
#define BASE_FUNCTIONPARSER_H
 ...
 */
template <int dim>
class FunctionParser : public LightFunction<dim>
{
public:
  /**
   ...
   */
  virtual double
  evaluate(const Point<dim> &p, const double time) const;
