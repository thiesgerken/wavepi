...
ConstantMaxIterChoice::ConstantMaxIterChoice(int max_iter)
      : max_iter(max_iter) {
}

ConstantMaxIterChoice::ConstantMaxIterChoice(ParameterHandler &prm) {
   get_parameters(prm);
}
...
int ConstantMaxIterChoice::calculate_max_iter() const {
   return max_iter;
}
