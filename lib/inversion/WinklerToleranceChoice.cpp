...
WinklerToleranceChoice::WinklerToleranceChoice(double tol_max, double zeta, double beta,
                                             bool safeguarding)
    : tol_max(tol_max), zeta(zeta), beta(beta), safeguarding(safeguarding) {}

WinklerToleranceChoice::WinklerToleranceChoice(ParameterHandler &prm) { get_parameters(prm); }

void WinklerToleranceChoice::declare_parameters(ParameterHandler &prm) {
  prm.enter_subsection("WinklerToleranceChoice");
  {
...
void WinklerToleranceChoice::get_parameters(ParameterHandler &prm) {
  prm.enter_subsection("WinklerToleranceChoice");
  {
...
double WinklerToleranceChoice::calculate_tolerance() const {
